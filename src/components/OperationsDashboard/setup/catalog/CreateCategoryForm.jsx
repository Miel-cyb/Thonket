                ...
                <form onSubmit={handleSubmit} className="p-8 space-y-6">
                    ...
                    <div className="space-y-2">
                        <div className="flex justify-between items-center px-1">
                            <label className="text-[11px] font-bold text-slate-500 uppercase tracking-wider">Distribution Level</label>
                    ...
                    {/* Name */}
                    <div className="space-y-2">
                        <label className="text-[11px] font-bold text-slate-500 uppercase tracking-wider px-1">Category Label</label>
                        <input
                            autoFocus
                            value={name}
                    ...
                    {/* Description */}
                    <div className="space-y-2">
                        <label className="text-[11px] font-bold text-slate-500 uppercase tracking-wider px-1">Operational Details</label>
                        <textarea
                            rows={3}
                            value={description}
                    ...
                    <div className="flex gap-4 pt-4 border-t border-slate-50">
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className={`flex-2 flex items-center justify-center gap-2 bg-indigo-600 text-white px-10 py-4 rounded-xl text-sm font-bold hover:bg-indigo-700 transition-all shadow-lg shadow-indigo-200 active:scale-[0.98] ${loading ? 'opacity-60 cursor-not-allowed' : ''}`}
                        >
                            {loading ? (
                                <svg
