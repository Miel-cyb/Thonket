 ...
 * Props:
 *  orders, setOrders
 *  onGeneratePicklist(order)
 *  onMarkReady(orderId)
 *  onConfirm(orderId)
 *  onFlagDelayed(orderId, note)
 */
const OrderTable = ({ orders, setOrders, onGeneratePicklist, onMarkReady, onConfirm, onFlagDelayed }) => {
